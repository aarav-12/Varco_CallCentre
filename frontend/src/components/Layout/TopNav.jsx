...
export default function TopNav({ onMenuToggle }) {
  ...
  return (
    <header className="h-16 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-4 gap-4 sticky top-0 z-10">
      ...
      <div className="flex items-center gap-3 flex-1 min-w-0">
        ...
        <form onSubmit={handleSearch} className="hidden sm:flex items-center gap-2 bg-gray-100 dark:bg-gray-800 rounded-lg px-3 py-2 w-64">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          ...
          >
            <div className="w-7 h-7 rounded-full bg-primary-700 flex items-center justify-center text-white text-sm font-semibold">
